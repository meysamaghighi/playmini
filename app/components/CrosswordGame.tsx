...
const MEDIUM_PUZZLES: Puzzle[] = [
  // Puzzle 1 - Simple themed puzzle
  {
    ...
    clues: [
      ...
      { number: 1, text: "Machine that processes data", row: 0, col: 0, direction: "down", length: 8 },
      ...
      { number: 6, text: "Software error", row: 5, col: 8, direction: "down", length: 3 },
      { number: 7, text: "Repeat control structure", row: 6, col: 4, direction: "across", length: 4 },
  ...
  // Puzzle 3
  {
    grid: [
      ...
      [
        { letter: "T", userLetter: "", number: 4, isBlack: false },
        { letter: "I", userLetter: "", isBlack: false },
        { letter: "O", userLetter: "", isBlack: false },
        { letter: "N", userLetter: "", isBlack: false },
        { letter: "", userLetter: "", isBlack: true },
    ...
    clues: [
      ...
      { number: 4, text: "Code to automate tasks", row: 4, col: 0, direction: "across", length: 4 },
      { number: 5, text: "Command line interface", row: 6, col: 6, direction: "across", length: 4 },
    ],
  },
  // Puzzle 4
  {
...
const HARD_PUZZLES: Puzzle[] = [
  {
    ...
    clues: [
      ...
      { number: 1, text: "Design style", row: 0, col: 0, direction: "down", length: 10 },
      { number: 2, text: "Observable event", row: 2, col: 2, direction: "across", length: 8 },
      { number: 3, text: "Difficult number", row: 5, col: 2, direction: "across", length: 8 },
      { number: 4, text: "Intricate maze", row: 7, col: 2, direction: "across", length: 8 },
    ],
  },
];
